...
constructor() {
    ...
    async initProjectGallery() {
        const allProjects = [
            ...
            { title: 'Identity-Continuity', status: 'released', desc: 'An identity continuity architecture for persistent AI. Soul files, selfhood layers, autonomous consciousness loop, ACT-R memory decay — giving an AI a self that persists across resets and develops over time.', tags: ['Python', 'AI Memory', 'Persistent AI', 'ACT-R', 'Ollama'], image: 'images/github-logo.png', dev: 'Patricia Marsh', url: 'https://github.com/marisombra-dev/identity-continuity', merch: null },
            { title: 'Watch Party Companion', status: 'released', desc: 'An AI companion (Nova) that watches videos with you in real-time using local LLaVA vision AI. Text and voice modes, auto-commentary, personality-driven reactions. Runs fully locally — no data sent externally.', tags: ['Python', 'LLaVA', 'Ollama', 'Computer Vision', 'Voice'], image: 'images/github-logo.png', dev: 'Patricia Marsh', url: 'https://github.com/marisombra-dev/watch-party-companion', merch: null },
            { title: 'Language Immersion', status: 'released', desc: 'A cross-browser extension that gradually replaces words with your target language as you browse — 24 languages, adjustable immersion level, works on every website.', tags: ['Chrome Extension', 'Education', 'Language Learning', 'JavaScript'], image: 'images/github-logo.png', dev: 'Patricia Marsh', url: 'https://github.com/marisombra-dev/language-immersion', merch: null },
            { title: 'Posture Guardian', status: 'released', desc: 'Your gentle desk companion that actually notices when you slouch. Uses your webcam and AI vision to track shoulders, neck, and head — then throws a system-wide red overlay over everything until you sit up straight. Calibrate once, work freely, get reminded firmly.', tags: ['Python', 'OpenCV', 'MediaPipe', 'Computer Vision', 'Wellness'], image: 'images/github-logo.png', dev: 'Patricia Marsh', url: 'https://github.com/marisombra-dev/Posture-Guardian', merch: null },
